...
<div class="container">
    ...
    <div> <span style="color:red;">*</span> YOUR PIN IS CONFIDENTIAL</div>
    <div>NOBODY SHOULD SEE THE PIN</div>
    <div>WHILE YOU ARE ENTERING IT.</div>
    <div>CHANGING IT FREQUENTLY</div>
...
if (isset($_POST['pass'])) {
    ...
    if ($_POST['pass'] == $_SESSION['pin']) {
        ...
        echo "<script>
        setTimeout(function() {
            window.location.href = 'mobile_register.php';
        }, 5000);
      </script>";
    } else {
